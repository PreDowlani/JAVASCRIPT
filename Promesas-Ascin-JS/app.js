...
const listaDeAutorizaciones = () => {
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => {
      if (!error) {
        resolve("Autorizaciones descargadas correctamente");
      } else {
...
// Alternativamente al try..catch previo podemos usar async..await
const procesar = async () => {
  try {
    const respuesta = await listaDeAutorizaciones(); // espera a que se ejecute la parte correspondiente de la promesa
